<?php
	...
	function goodBye() {
		echo "This was printed from a function.<br /><br />Notice that we are using PHP to print out an HTML file that the browser is using to show this page.<br />Right-click and 'view source' to see what we printed.<br /><br />Have a nice day.";
	}
	...
	*/
	...
	echo "<h1>Look how easy it is to print out HTML from PHP.</h1><img src=\"http://www.oyepictures.com/o/congratulations/congratulations_002.jpg\" style='height: 200px' /><h1>Now we can have more powerful, dynamically-controlled websites.</h1><br />";
	...
	*/
	$myString = "quotes";
	echo "<br />You can print variables inside the $myString.";
	...
	echo "A function printed the last $myVar line breaks.<br />";
